...
document.addEventListener('DOMContentLoaded', () => {
    ...
    navLinks.forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            // CERRAR MENÚ MÓVIL AL SELECCIONAR (UX Móvil)
    ...
    // --- INICIALIZAR EN HOME (Mostrar todos los módulos) ---
    showModule('todos'); 
    
    console.log('✅ Sistema Portafolio Iniciado');
});